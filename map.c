	...
	for (int row = 0; row < MAP_HEIGHT; row++) {
		for (int col = 0; col < MAP_WIDTH; col++) {
			...
			case 1:
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->platform[5], row, col, 0, 0);
				break;
			case 2:
			...
			case 4: // fire trap lv1
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->fire_trap[0], row, col, 0, 0);
				break;
			case 5: // fire trap lv2
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->fire_trap[1], row, col, 0, 0);
				break;
			case 6: // fire trap lv3
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->fire_trap[2], row, col, 0, 0);
				break;
			case 7: // ceiling trap lv1 but always lethal and stable
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->ceiling_trap[0], row, col, 180, 0);
				break;
			case 8: // ceiling trap lv1 speed low
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->ceiling_trap[0], row, col, 0, 0);
				break;
			...
			case 11: // saw trap lv1 in the floor
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->saw_trap[0], row, col, 180, 0);
				break;
			case 12: // saw trap lv1 in the ceiling
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->saw_trap[0], row, col, 0, 0);
				break;
			case 13: // first aid kit
				if (!map->ledges[row][col].isObtained) {
					...
					drawTilesMap(gameState, renderer, *map, srcRect, gameState->items[0], row, col, 0, 0);
				}
				break;
			...
			case 15: // lightning trap lv2 with super slow
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->lightning_trap[1], row, col, 0, 0);
				break;
			...
			case 19: // smol golem
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->golem[0], row, col, 0, map->ledges[row][col].smolGolem.flip);
				break;
			...
			case 22:
				...
				drawTilesMap(gameState, renderer, *map, srcRect, gameState->sparkling_star[0], row, col, 0, 0);
				break;
			}
		}
	}
